...
def delete() :
    ...
    # empty input in task number field then check error
    if number == "\n" :
        messagebox.showerror("input error")
        return
...
if __name__ == "__main__" :
    ...
    gui.title("ToDo  GUI Application")
    ...
    # when user press the button, the command or 
    # function affiliated to that button is executed .
    Exit = Button(gui, text = "Exit", fg = "white", bg = "blue", command = exit)
